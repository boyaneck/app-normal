...
const ChatSanction = ({
  ...
  return (
    <div className="absolute top-2 z-10  bg-green-400 border rounded-xl border-black w-4/5 h-auto flex items-center left-1/2 -translate-x-1/2">
      ...
      >
        ...
        <span className="ml-2 align-middle">
          ID: {selected_message_for_modal?.user_nickname}FRANCE
        </span>
        <div className="w-3/4 mx-auto mt-2 p-2 bg-gray-100 rounded">
      ...
      {animating_item ? (
        ...
        //         {animating_item.item.reason}item_reason
        //       </h2>
        //     </div>
